package br.usjt.lifecicle.util;

/**
 * Created by leonardo_soares on 06/03/2018.
 */
...
public class Utils {
    ...
    private static br.usjt.lifecicle.util.StatusTracker mStatusTracker = br.usjt.lifecicle.util.StatusTracker.getInstance();
